...
![image-20210125155625394](../../tmp/image-20210125155625394.png)
...
![image-20210125192558317](../../tmp/image-20210125192558317.png)
...
![image-20210125194430656](../../tmp/image-20210125194430656.png)
...
매초마다 컨슈머의 메서드가 실행된다! 자 이제 이걸로 미션풀면 되겠다.

## 미션

![image-20210126014730855](../../tmp/image-20210126014730855.png)

이렇게 구현하려고 한다.

구현했고, 잘 돌아간다. 정리하고 자고 싶은데 너무 늦었다. 내일 이어서 정리하도록 하자

아니 근데 진짜 잘 돌아가는거 맞나? 내일 일어나서 다시 테스트해보자.
